...
#             # print("small nerf iteration 4: h ",l, " ", h.shape)
#             # print("small nerf iteration 5: linear layer ", self.color_net[l])
...
#         self.conv1 = torch.nn.Conv1d(48, 32, 3, padding="same")
#         self.conv2 = torch.nn.Conv1d(32, 16, 3, padding="same")
#         self.conv3 = torch.nn.Conv1d(16, 8, 3, padding="same")
#         self.conv4 = torch.nn.Conv1d(8, 4, 3, padding="same")

#     def forward(self, x):
#         x = x.reshape(1, 48, x.shape[0])
#         x = self.conv1(x)
#         x = self.conv2(x)
#         x = self.conv3(x)
#         x = self.conv4(x)
